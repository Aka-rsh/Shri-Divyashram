...
const itinerary = [
  {
    title: "सुबहे बनारस और गंगा आरती",
...
<div className="bg-[#e1fae2]">
  <h1 className="text-2xl text-center underline-offset-4 underline mt-4">One Day tour with Divyashram</h1>
  ...
  {itinerary.map((item, index) => (
    <React.Fragment key={index}>
      ...
      >
        ...
        {/* Optional Contact Section (Non-WhatsApp) */}
        <div className="text-center mt-16 p-8 bg-white shadow rounded max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-800 mb-3">Interested in Planning a Custom Varanasi Tour?</h2>
          <p className="text-gray-600 mb-5">
            Contact us to get detailed itineraries, expert guidance, and personalized travel support.
          </p>
          <Link to="/contact">
            <button className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-3 rounded transition">
              Contact Us
            </button>
          </Link>
        </div>
